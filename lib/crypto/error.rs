...
use super::asymmetric_key_ext::{ReadFileError, WriteFileError};

/// Errors specific to cryptographic functionality.
#[derive(Debug, Error)]
pub enum Error {
    ...
    /// Error while decoding a type from a hex-encoded representation.
    ...
    /// Error while decoding a type from a base64 representation.
