...
pub(crate) mod show_simple_arg_examples {
    use super::*;

    pub(crate) const ARG_NAME: &str = "show-simple-arg-examples";
...
pub(crate) mod show_json_args_examples {
    use super::*;

    pub(crate) const ARG_NAME: &str = "show-json-args-examples";
...
pub(crate) fn session_str_params(matches: &ArgMatches) -> SessionStrParams<'_> {
...
pub(crate) fn payment_str_params(matches: &ArgMatches) -> PaymentStrParams<'_> {
...
pub(crate) mod session_path {
    use super::*;

    pub(crate) const ARG_NAME: &str = "session-path";
...
pub(crate) mod payment_path {
    use super::*;

    pub(crate) const ARG_NAME: &str = "payment-path";
    const ARG_VALUE_NAME: &str = common::ARG_PATH;
...
pub(crate) mod standard_payment_amount {
    use super::*;

    pub(crate) const ARG_NAME: &str = "payment-amount";
    ...
    pub(crate) fn arg(default_value: Option<&'static str>) -> Arg {
        Arg::new(ARG_NAME)
            .long(ARG_NAME)
            .short(ARG_SHORT)
            .required(false)
...
pub(crate) fn apply_common_creation_options(
    subcommand: Command,
...
pub(crate) fn apply_common_session_options(subcommand: Command) -> Command {
    subcommand
...
pub(crate) fn show_simple_arg_examples_and_exit_if_required(matches: &ArgMatches) {
...
pub(crate) fn show_json_args_examples_and_exit_if_required(matches: &ArgMatches) {
    // If we printed the arg examples, exit the process.
...
pub(crate) mod is_session_transfer {
    use super::*;
...
pub(crate) mod transaction_kind {
    ...
    pub const ARG_NAME: &str = "transaction-kind";
    const ARG_VALUE_NAME: &str = common::ARG_STRING;
    const ARG_HELP: &str = "The type of transaction to be constructed";
    ...
    pub fn arg() -> Arg {
        Arg::new(ARG_NAME)
            ...
            .help(ARG_HELP)
            .required(false)
            .display_order(DisplayOrder::TransactionKind as usize)
    }
...
pub(crate) mod transaction_kind_args {
    use super::*;

    pub const ARG_NAME: &str = "transaction-kind-arg";
    const ARG_VALUE_NAME: &str = common::ARG_STRING;
    const ARG_HELP: &str =
        "an argument needed to construct the transaction body based on the transaction kind";
    ...
    pub fn arg() -> Arg {
        Arg::new(ARG_NAME)
            ...
            .help(ARG_HELP)
            .required(false)
            .display_order(DisplayOrder::TransactionKindArg as usize)
    }
